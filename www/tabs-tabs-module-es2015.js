...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'non-login',
                loadChildren: () => __webpack_require__.e(/*! import() | non-login-non-login-module */ "non-login-non-login-module").then(__webpack_require__.bind(null, /*! ../non-login/non-login.module */ "./src/app/non-login/non-login.module.ts")).then(m => m.NonLoginModule)
            },
            {
                path: '',
