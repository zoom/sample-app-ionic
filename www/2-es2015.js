...
const Alert = class {
    ...
    callButtonHandler(button, data) {
        if (button && button.handler) {
            ...
            const returnData = Object(_overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_6__["s"])(button.handler, data);
            if (returnData === false) {
    ...
    renderInput(labelledby) {
        ...
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
            if (i.type === 'textarea') {
                return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "alert-input-wrapper" }, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("textarea", { placeholder: i.placeholder, value: i.value, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
    ...
    renderAlertButtons() {
        ...
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: alertButtonGroupClass }, buttons.map(button => Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "alert-button-inner" }, button.text), mode === 'md' && Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", null)))));
    }
    render() {
