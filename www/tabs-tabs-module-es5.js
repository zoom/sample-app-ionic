  ...
  function srcAppTabsTabsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | non-login-non-login-module */
          "non-login-non-login-module").then(__webpack_require__.bind(null,
          /*! ../non-login/non-login.module */
          "./src/app/non-login/non-login.module.ts")).then(function (m) {
            return m.NonLoginModule;
          });
        }
      }, {
        path: '',
