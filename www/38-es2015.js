...
/* harmony import */ var _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-e98418f5.js */ "./node_modules/@ionic/core/dist/esm/index-e98418f5.js");
...
/* harmony import */ var _overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-7e61a613.js */ "./node_modules/@ionic/core/dist/esm/overlays-7e61a613.js");
...
const iosEnterAnimation = (baseEl, presentingEl) => {
    ...
    if (presentingEl) {
        ...
        const presentingAnimation = Object(_animation_47fafd47_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
            .beforeStyles({
        ...
        if (isMobile) {
            ...
            if (!hasCardModal) {
                ...
                const shadowAnimation = Object(_animation_47fafd47_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                    .afterStyles({
                    'transform': finalTransform
                })
...
const Modal = class {
    constructor(hostRef) {
        ...
        this.onBackdropTap = () => {
            this.dismiss(undefined, _overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_8__["B"]);
        };
        this.onDismiss = (ev) => {
            ev.stopPropagation();
            ev.preventDefault();
    ...
    async present() {
        ...
        await Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
        Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_0__["w"])(() => this.el.classList.add('show-modal'));
        await Object(_overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_8__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
    ...
    initSwipeToClose() {
        ...
        const animationBuilder = this.leaveAnimation || _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_1__["c"].get('modalLeave', iosLeaveAnimation);
    ...
    async dismiss(data, role) {
        ...
        const enteringAnimation = _overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_8__["h"].get(this) || [];
        const dismissed = await Object(_overlays_7e61a613_js__WEBPACK_IMPORTED_MODULE_8__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
        if (dismissed) {
